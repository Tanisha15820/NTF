  ...
  const cards = [
    {
      title: "Dashboard",
      description:
        "Get an overview of all key metrics and performance.",
      path: "/dashboard",
    ...
    },
    {
      title: "LMS",
      description:
        "Manage learning content, assessments and training.",
      path: "/lms",
    ...
    },
    {
      title: "CMS",
      description:
        "Create, manage and organize content across the platform.",
      path: "/cms",
